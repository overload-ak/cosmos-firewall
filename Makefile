...
ldflags = '-X github.com/overload-ak/fx-firewall.Version=$(VERSION) \
           -X github.com/overload-ak/fx-firewall.Commit=$(COMMIT) \
           -X github.com/overload-ak/fx-firewall.BuildTime=$(BuildTime) \
           -w -s'
